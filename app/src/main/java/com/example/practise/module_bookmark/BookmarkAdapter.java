...
import com.example.practise.databinding.BookmarkItemBinding;
...
//        holder.itemView.setTag(position);//设置Tag
    ...
    //是否显示复选框
    public void showCheckBox(BookmarkItemBinding binding, int position, BookmarkBean bookmarkBean){
    ...
    //获取所选项的id值
    public List<BookmarkBean> getCheckedItems(){
